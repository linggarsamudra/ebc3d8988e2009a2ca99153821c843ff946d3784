                ...
                <div className="fixed bottom-0 px-4 py-4 bg-white w-full rounded-t-2xl h-2/3">
                    ...
                    <div className="flex w-full mt-2">
                        ...
                        <div className="relative text-gray-700 focus-within:text-gray-400 w-full">
                            ...
                            <input type="search" className="py-2 text-sm text-white bg-gray-200 rounded-md pl-12 focus:outline-none focus:bg-white focus:text-gray-900 w-full" placeholder="Search..." />
                        </div>
                    </div>
